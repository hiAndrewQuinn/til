---
title: Replacing a 3 GB SQLite database with a 10 MB FST (finite state trandsucer) binary
date: 2026-05-10
tags: 
- against-entropy
---
...
digit, because I'm a fan of Rob Eastway's
...
a Finnish-English dictionary with incremental search to type.
...
of `tsk`, which was in Go. ... With a few basic optimizations.
...
[Had I considered rewriting it in Rust?](https://transitiontech.ca/random/RIIR)
...
FST thingies. I mean, it was always obvious that was
...
and declensions of a highly agglunitative language
...
or the good nothing, I chose to do the bad easy thing.
The SQLite database worked! I *understood*
how it worked, behind the scenes with its BTrees and its
Full Text Search extension. I think I even used that same
FTS extesnsion to power certain lesser used features that
